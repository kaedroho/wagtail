...
class TestStreamFieldComparison(TestCase):
    ...
    def test_add_block(self):
        ...
        self.assertEqual(comparison.htmldiff(), '<div class="comparison__child-object">Content</div><div class="comparison__child-object addition">New Content</div>')
        self.assertIsInstance(comparison.htmldiff(), SafeText)
        self.assertTrue(comparison.has_changed())
    ...
    def test_delete_block(self):
        ...
        self.assertEqual(comparison.htmldiff(), '<div class="comparison__child-object">Content</div><div class="comparison__child-object deletion">Content Foo</div><div class="comparison__child-object">Content Bar</div>')
        self.assertIsInstance(comparison.htmldiff(), SafeText)
        self.assertTrue(comparison.has_changed())
    ...
    def test_edit_block(self):
        ...
        self.assertEqual(comparison.htmldiff(), '<div class="comparison__child-object">Content</div><div class="comparison__child-object">Content <span class="deletion">Foo</span><span class="addition">Baz</span></div><div class="comparison__child-object">Content Bar</div>')
        self.assertIsInstance(comparison.htmldiff(), SafeText)
        self.assertTrue(comparison.has_changed())
