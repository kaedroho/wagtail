...
class ModelModule(Module):
    ...
    def get_urls(self):
        return (
            url(r'^$', ModelIndexView.as_view(module=self), name='index'),
            url(r'^new/$', ModelCreateView.as_view(module=self), name='create'),
            url(r'^(?P<pk>\d+)/$', ModelUpdateView.as_view(module=self), name='update'),
            url(r'^(?P<pk>\d+)/delete/$', ModelDeleteView.as_view(module=self), name='delete'),
        )
