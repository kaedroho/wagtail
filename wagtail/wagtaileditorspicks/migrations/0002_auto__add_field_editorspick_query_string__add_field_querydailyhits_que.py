...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EditorsPick.query_string'
        db.add_column(u'wagtaileditorspicks_editorspick', 'query_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, db_index=True),
                      keep_default=False)

        # Adding field 'QueryDailyHits.query_string'
        db.add_column(u'wagtaileditorspicks_querydailyhits', 'query_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EditorsPick.query_string'
        db.delete_column(u'wagtaileditorspicks_editorspick', 'query_string')

        # Deleting field 'QueryDailyHits.query_string'
        db.delete_column(u'wagtaileditorspicks_querydailyhits', 'query_string')
