...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for editors_pick in orm.EditorsPick.objects.all():
            editors_pick.query_string = editors_pick.query.query_string
            editors_pick.save()

        for query_daily_hits in orm.QueryDailyHits.objects.all():
            query_daily_hits.query_string = query_daily_hits.query.query_string
            query_daily_hits.save()
