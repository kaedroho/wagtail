...
class TestAdminPageListing(AdminAPITestCase, TestPageListing):
    ...
    def test_all_fields(self):
        ...
        for page in content['items']:
            ...
            self.assertEqual(set(page['meta'].keys()), {'type', 'detail_url', 'show_in_menus', 'first_published_at', 'seo_title', 'slug', 'parent', 'html_url', 'search_description', 'children', 'status', 'latest_revision_created_at'})
    ...
    def test_all_fields_then_remove_something(self):
        ...
        for page in content['items']:
            ...
            self.assertEqual(set(page['meta'].keys()), {'type', 'detail_url', 'show_in_menus', 'first_published_at', 'slug', 'parent', 'html_url', 'search_description', 'children', 'latest_revision_created_at'})
