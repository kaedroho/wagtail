...
class DeleteBulkAction(VideoBulkAction):
    display_name = _("Delete")
    action_type = "delete"
    aria_label = _("Delete selected videos")
    template_name = "wagtailvideos/bulk_actions/confirm_bulk_delete.html"
    action_priority = 100
    classes = {"serious"}
    ...
    def get_success_message(self, num_parent_objects, num_child_objects):
        return ngettext(
            "%(num_parent_objects)d video has been deleted",
            "%(num_parent_objects)d videos have been deleted",
            num_parent_objects,
