...
def register_core_log_actions(actions):
    ...
    actions.register_action('wagtail.publish.scheduled', _("Publish scheduled draft"), _('Published scheduled draft'), parent='wagtail.publish')
    actions.register_action('wagtail.unpublish', _('Unpublish'), _('Unpublished'))
    actions.register_action('wagtail.unpublish.scheduled', _('Unpublish scheduled draft'), _('Unpublished scheduled draft'), parent='wagtail.unpublish')
    ...
    actions.register_action('wagtail.rename', _('Rename'), rename_message, parent='wagtail.edit')
    actions.register_action('wagtail.revert', _('Revert'), revert_message, parent='wagtail.edit')
    actions.register_action('wagtail.copy', _('Copy'), copy_message, parent='wagtail.create')
