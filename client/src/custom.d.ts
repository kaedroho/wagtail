...
declare module 'gettext' {
    ...
    type FormatType =
        ...
        'TIME_INPUT_FORMATS' |
        'YEAR_MONTH_FORMAT';
    export function get_format(formatType: FormatType): string;

    // https://docs.djangoproject.com/en/3.1/topics/i18n/translation/#gettext_noop
    export function gettext_noop(text: string): string;
    ...
    export function pgettext(context: string, text: string, count: number): string;
