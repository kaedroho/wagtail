...
from wagtail.core.admin.rich_text.converters.editor_html import LinkTypeRule
from wagtail.core.admin.rich_text.converters.editor_html import \
    PageLinkHandler as RichTextPageLinkHandler
...
from wagtail.core.admin.views.account import email_management_enabled, password_management_enabled
...
from wagtail.core.models import PageViewRestriction, UserPagePermissionsProxy
...
def register_core_features(features):
    ...
    features.register_converter_rule('editorhtml', 'link', [
        ...
        LinkTypeRule('page', RichTextPageLinkHandler),
    ])
