...
# TODO: We probably should think about splitting up this models.py file now
...
class Page(AbstractPage, index.Indexed, ClusterableModel, metaclass=PageBase):
    ...
    def copy(self, recursive=False, to=None, update_attrs=None, copy_revisions=True, keep_live=True, user=None, process_child_object=None, exclude_fields=None, reset_translation_key=True):
        ...
        if reset_translation_key:
            page_copy.translation_key = uuid.uuid4()
...
class PagePermissionTester:
    ...
    def can_move_to(self, destination):
        ...
        # TODO: What about the root?
        if destination.locale_id != self.page.locale_id:
            return False
