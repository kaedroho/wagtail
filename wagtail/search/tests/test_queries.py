...
from wagtail.search.utils import balanced_reduce, normalise_query_string, separate_filters_from_query
...
class TestBalancedReduce(SimpleTestCase):
    ...
    def test_is_balanced(self):
        ...
        self.assertEqual(
            repr(balanced_reduce(CombinedNode, [Node(letter) for letter in ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H']])),
            '(((A B) (C D)) ((E F) (G H)))'
