...
export class StoryBlock extends BaseSequenceBlock {
...
export class StoryBlockDefinition {
  ...
  render(placeholder, prefix, initialState, initialError) {
    return new StoryBlock(this, placeholder, prefix, initialState, initialError);
  }
}
