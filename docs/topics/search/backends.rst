...
The database backend makes use of the full text search features of the database backend in use.
This backend is intended to be used for development and also should be good enough for simple sites to use in production too.
